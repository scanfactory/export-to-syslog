...
Экспортер событий из ЛК ScanFactory на удаленные syslog серверы в формате RFC5424

## Описание

Скрипт собирает события из нескольких источников:

1. **Scanfactory** - события из множества ЛК ScanFactory через API
2. (опционально) **Keycloak** - события аутентификации и администрирования. Примечание: в новых версиях KeyCloak, экспорт событий доступен без этого скрипта - см. документацию Admin Guide.pdf
